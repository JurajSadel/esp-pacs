...
#[doc = "Register `HSCH2_DUTY` writer"]
pub struct W(crate::W<HSCH2_DUTY_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSCH2_DUTY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSCH2_DUTY_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSCH2_DUTY_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DUTY_HSCH2` reader - "]
pub type DUTY_HSCH2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DUTY_HSCH2` writer - "]
pub type DUTY_HSCH2_W<'a> = crate::FieldWriter<'a, u32, HSCH2_DUTY_SPEC, u32, u32, 25, 0>;
impl R {
    #[doc = "Bits 0:24"]
    #[inline(always)]
...
#[doc = "`write(|w| ..)` method takes [hsch2_duty::W](W) writer structure"]
impl crate::Writable for HSCH2_DUTY_SPEC {
    type Writer = W;
}
