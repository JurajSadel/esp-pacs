...
#[doc = "Register `HSCH1_DUTY` writer"]
pub struct W(crate::W<HSCH1_DUTY_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSCH1_DUTY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSCH1_DUTY_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSCH1_DUTY_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DUTY_HSCH1` reader - "]
pub type DUTY_HSCH1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DUTY_HSCH1` writer - "]
pub type DUTY_HSCH1_W<'a> = crate::FieldWriter<'a, u32, HSCH1_DUTY_SPEC, u32, u32, 25, 0>;
impl R {
    #[doc = "Bits 0:24"]
    #[inline(always)]
...
#[doc = "`write(|w| ..)` method takes [hsch1_duty::W](W) writer structure"]
impl crate::Writable for HSCH1_DUTY_SPEC {
    type Writer = W;
}
